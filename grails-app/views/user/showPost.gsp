                ...
                <div class="card border-2 mt-4" style="border-radius: 25px;">
                    <div class="card-body" >
                        ...
                        <div class="row">
                            <div class="col-sm-2 mt-2">
                                <g:if test="${session.currentUser}">
                                    <a href="/User/userProfile?user=${postDetails.resource.createdBy.id}"><g:img dir="images" id="profilePhoto"  file="${postDetails.resource.createdBy.photo}" width="80" height="100"/></a>
                                </g:if>
                            </div>
                            <div class="col-sm-4">
                                <div class="row">
                                    <a href="/User/userProfile?user=${postDetails.resource.createdBy.id}"><h5 class="card-text">${postDetails.resource.createdBy.firstName +"."+postDetails.resource.createdBy.lastName}</h5></a>
                                </div>
                                <div class="row">
                                    <p class="card-text text-muted"><a href="/User/userProfile?user=${postDetails.resource.createdBy.id}">@${postDetails.resource.createdBy.userName}</a></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="row">
                                    <p><a href="/TopicShow/index?topicId=${postDetails.resource.topic.id}">${postDetails.resource.topic.name}</a></p>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group" >
                                            <input type="radio" id="star1" name="star1" value="1" onclick="postRating(${postDetails.resource.id},1)" /><label for="star1"></label>
                                            <input type="radio" id="star2" name="star2" value="2" onclick="postRating(${postDetails.resource.id},2)"/><label for="star2"></label>
                                            <input type="radio" id="star3" name="star3" value="3" onclick="postRating(${postDetails.resource.id},3)"/><label for="star3"></label>
                                            <input type="radio" id="star4" name="star4" value="4" onclick="postRating(${postDetails.resource.id},4)"/><label for="star4"></label>
                                            <input type="radio" id="star5" name="star5" value="5" onclick="postRating(${postDetails.resource.id},5)"/><label for="star5"></label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <h5>No.of Ratings</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <g:if test="${postDetails.resource.instanceOf(LinkResource)}"><a href="${postDetails.resource.url}" target="_blank" style="font-size: small; margin-left:2ch">View Full Site</a></g:if>
                                <g:else><a href="${postDetails.resource.filePath}" style="font-size:small">Download</a></g:else>
                                <a href="/ShowPost/index?resourceId=${postDetails.resource.id}" style="font-size: small; margin-left:2ch">View Post</a>
                            </div>
                        </div>
                    </div>
                </div>
                                   ...
                                   <div class="row" id="trendingTopic_${trending.topic.id}">
                                       ...
                                       <div class="row border-bottom">
                                           ...
                                           <g:if test="${session.currentUser.id==trending.topic.createdBy.id || session.currentUser.isAdmin==true}">
                                               <div class="col-sm-3">
                                                   <div class="dropdown" style="max-width:120px">
                                                       <g:select class="form-select" id="trendingTopicVisibility_${trending.topic.id}" name="visibility_${trending.topic.id}" value="visibility" aria-label="Select visibility"
