                        ...
                        <div class="card " >
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <p class="card-text text-muted"><a href="/User/userProfile?user=${topicDetails.topic.createdBy.id}">@${topicDetails.topic.createdBy.userName}</a></p>
                                    <div class="row">
                                        <div class="col-sm-5">
                            ...
                            <g:each in="${topicUser}" var="topic">
                                <div class="row mt-3">
                                    <div class="col-sm-2 mt-3">
                                        <a href="/User/userProfile?user=${topic.user.id}"><g:img dir="images" file="${topic.user.photo}"  width="80" height="80"/></a>
                                    </div>
                                    <div class="col-md-8">
                                        <h5>${"${topic.user.firstName}"+"."+"${topic.user.lastName}"}</h5>
                                        <p><a href="/User/userProfile?user=${topic.user.id}"><span>@${topic.user.userName}</span></a></p>
                                        <div class="row">
                                            <div class="col">
        ...
        <div class="col-sm-6 mt-4">
            <div class="card border-1">
                ...
                <div class="card-body" style="background-color: rgba(69, 68, 70, 0.144);">
                    <g:each in="${topicPost}" var="topicPost">
                        <div class="row mt-2">
                            <div class="col-sm-2">
                                <a href="/User/userProfile?user=${topicPost.createdBy.id}"><g:img dir="images" file="${topicPost.createdBy.photo}"  width="80" height="80"/></a>
                            </div>
                            <div class="col-sm-10">
                                <h5>${topicPost.description}</h5>
                                <div class="row mt-4">
                                    <div class="col-sm-2">

                                    </div>
                                    <div class="col-sm-10 offset-3">
                                        <g:if test="${topicPost.instanceOf(linkshare.LinkResource)}"><a href="${topicPost.url}" style="font-size: small; margin-left:2ch">View Full Site</a></g:if>
                                        <g:else><a href="${topicPost.filePath}" style="font-size:small">Download</a></g:else>
                                        <a href="#" style="font-size: small; margin-left:2ch">Mark As Read</a>
                                        <a href="/ShowPost/index?resource=${topicPost.id}" style="font-size: small; margin-left:2ch">View Post</a>
                                    </div>
                                </div>
                            </div>
                            <span class="border border-secondary mt-1"></span>
